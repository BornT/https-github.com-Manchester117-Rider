package com.rider.generator.core;

import com.rider.mobile.param.ParameterObject;
import com.rider.mobile.wrapper.FunctionWrapper;
import com.rider.operatordata.ReadInitStruct;
import com.rider.operatordata.ReadTestStruct;
import com.rider.operatordata.TestDataExtract;
import javassist.*;
    ...
    public void createTestClass() {
        ...
        for (int i = 0; i < this.suiteList.size(); ++i) {
            ...
            for (String className : this.classNameList.get(i)) {
                subCtClass.add(this.cPool.makeClass("com.rider.test." + suiteName + "." + className));
            }
