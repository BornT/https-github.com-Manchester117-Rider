...
public class ClassDecompiler {
    ...
    public void getTestClassFileName() {
        String testClassPath = "target/classes/com/rider/test";
    ...
    public void decompilerClass() {
        String javaPrefixPath = "src/main/java/com/rider/test/";
        String classPrefixPath = "target/classes/com/rider/test/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        cd.decompilerClass();
        ConvertCodeFile ccf = new ConvertCodeFile();
        ccf.convertUnicodeFile();
    }
}
